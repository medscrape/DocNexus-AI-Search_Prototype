...
#!/usr/bin/env python3
"""
NLP to ClickHouse Main Agent
============================
Coordinates medical code extraction and table identification to generate ClickHouse queries.
"""
        ...
        self.table_schemas = {
            ...
            'as_providers_v1': {
                ...
                'key_columns': {
                    ...
                    'best_system_name': 'Primary health system affiliation',
                    'num_payments': 'Number of payments received',
                    'num_clinical_trials': 'Number of clinical trials participated in',
                    'num_publications': 'Number of publications authored'
                }
            }
        }
...
"""
    ...
    def generate_clickhouse_query(self, query: str) -> Dict[str, Any]:
        ...
        return self.generate_and_execute_query(query, execute=False)
...
def main():
    ...
    if result['success']:
        ...
        if not args.no_execute and result.get('execution_result'):
            print("\n📊 QUERY RESULTS:")
            print("="*80)
            print("Query executed successfully - results shown above")
